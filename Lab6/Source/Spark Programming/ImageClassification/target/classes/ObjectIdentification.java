...
class ObjectMainDetection {
    ...
    public void StartVideo() throws IOException {
        Video<MBFImage> video = new XuggleVideo(new File("data/InputVideo/Orlando1.mkv"));
        int count1 = 0, count2 = 0, count3 = 0;
        String o1 = "data/train/input.txt";
    ...
    public void LoadReferenceObject() {
        ...
        try {
            modelImage1 = ImageUtilities.readMBF(new File("data/InputVideo/11.png"));
            modelImage2 = ImageUtilities.readMBF(new File("data/InputVideo/12.png"));
            modelImage3 = ImageUtilities.readMBF(new File("data/InputVideo/13.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
