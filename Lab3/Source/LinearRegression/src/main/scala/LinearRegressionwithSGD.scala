...
/**
  * Created by nandanamudi on 2/8/2017.
  */
object LinearRegressionwithSGD {
  ...
  def main(args: Array[String]): Unit ={
    ...
    val data = sc.textFile("input//chimpanzee.data")
    ...
    // Save and load model
    model.save(sc, "output//LinearRegression")
    val sameModel = LinearRegressionModel.load(sc, "output//LinearRegression")
  }
